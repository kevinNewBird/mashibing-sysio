...
/**
 * description  SocketNIO 单线程里的非阻塞NIO <BR>
 * <p>
 * author: zhao.song
 * date: created in 23:57  2021/7/15
 * company: TRS信息技术有限公司
 * version 1.0
 */
...
//        StandardSocketOptions.SO_REUSEADDR
        ...
        while (true) {
            ...
            if (client == null) {
                ...
                //重点  socket（服务端的listen socket<连接请求三次握手后
                // ，往我这里扔，我去通过accept 得到  连接的socket>，连接socket<连接后的数据读写使用的> ）
