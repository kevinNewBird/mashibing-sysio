...
class NioThread extends Thread {
    ...
    NioThread(Selector sel, int n) {
        ...
        System.out.println("Boss 启动" + Thread.currentThread().getName());
    }

    NioThread(Selector sel) {
        this.selector = sel;
        id = idx.getAndIncrement() % selectors;
        System.out.println("worker: " + id + " 启动" + Thread.currentThread().getName());
    ...
    public void acceptHandler(SelectionKey key) {
        try {
            ...
            System.out.println("accept: " + currentThread().getName());
    ...
    public void readHandler(SelectionKey key) {
        System.out.println("read: " + currentThread().getName());
